...
// execTx executes a function whthin a database transaction.
...
// TransferTxResultis the result of the transfer transaction
...
// add account entries,
// update account's balance within a single database transaction
